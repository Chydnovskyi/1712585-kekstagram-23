...
const validateHashtag = function () {
  ...
  hashtags.forEach((element) => {
    ...
    if (!(re.test(element))) {
      errors.push('После решётки должны быть буквы и/или числа и не может быть пробелов,спецсимволов (#, @, $ и т. п.), символы пунктуации (тире, дефис, запятая и т. п.), эмодзи и т. д. Максимальная длина одного хэш-тега 20 символов, включая решётку');
    }
